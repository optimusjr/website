        ...
        <Page backgroundColor="secondary" fullHeight className={styles.services}>
          ...
          <ul className={styles.list}>
            ...
            <ServiceCard image={<Image src={Socket} alt="Foto de uma tomada" />}>
              ...
              <p>
                Com a automatização de tomadas elétricas, você pode controlar os eletrodomésticos da
                sua casa de qualquer lugar, economizando energia e facilitando sua vida.
              </p>
            </ServiceCard>
            ...
            <ServiceCard image={<Image src={Socket} alt="Foto de uma tomada" />}>
              ...
              <p>
                Ajuste a temperatura do Ar Condicionado, controle a Televisão e muito mais por meio
                do seu celular, por comandos de voz e até mesmo agendando horários para que
                funcionem sozinhos.
              </p>
            </ServiceCard>
            ...
            <ServiceCard image={<Image src={Socket} alt="Foto de uma tomada" />}>
              ...
              <p>
                ...
                funcionamento para que ela sempre circule a água sozinha no horário desejado por
                você.
              </p>
            </ServiceCard>
