...
const Content = () => (
  <>
    <Start>
      <StartIntro>
        <StartTitle strap="controle de dispositivos">
      ...
      <StartFeatures>
        <StartFeature
          Icon={SofaIcon}
          description="Gerencie diversos dispositivos eletrônicos e eletrodomésticos sem precisar interagir fisicamente com cada um"
          title="Conveniência e Facilidade"
        />
        <StartFeature
          Icon={ShieldHome}
          description="Crie cenários que simulam presença durante sua ausência e monitore o estado de dispositivos críticos, como câmeras de segurança e alarmes, em tempo real."
          title="Simule Presença, Afaste Intrusos"
        />
        <StartFeature
          Icon={Leaf}
          description="Programe  a cafeteira para começar a funcionar às 7h da manhã ou definir o ar-condicionado para ligar pouco antes de você chegar em casa."
          title="Programação e Personalização"
        />
      </StartFeatures>
    </Start>
